    ...
    public static class MLPTooltipManager
    {
        ...
        public static class MainComponent
        {
            ...
            public static void GenerateTooltips()
            {
                ...
                mainComponentBasicParameters.Add("Divide Volume On Probes Count", "If your volume is too large, it will automatically be divided into parts for " +
                ...
                mainComponentCullingOptions.Add("Filling Mode", "In Advanced workflow mode MLP can work in three different fill modes. " +
                    ...
                    "deleted.");
                mainComponentCullingOptions.Add("Light Intensity Threshold", "The threshold for culling of probes by the intensity of their illumination by light sources. " +
                    "The lower value, the greater the range of probes will be considered equivalent and will be culled.");
